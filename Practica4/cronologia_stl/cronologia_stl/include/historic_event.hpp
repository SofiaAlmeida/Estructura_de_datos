 ...
 *
 * Una instancia @e h del tipo de datos abstracto @c HistoricEvent se compone de un pareja del tipo pair conformada por 
 * una fecha y set de strings que representan uno o más eventos sucedidos en dicha fecha. La fecha
 * representará únicamente el año en el que tuvieron lugar los acontecimientos
 * en forma de número natural, y cada uno de los acontecimientos podrán contener más de una palabra.
 *
...
private: 
   ...
   *
   * rep.first#rep.set[0]#rep.set[1]...       ???              // PENDIENTE de indicar su correcta representación
   *
   */
  int date; /**< fecha */
...
public:
   ...
   * @brief Constructor de la clase
   * @param d fecha
   * @param c conjunto de acontecimientos ocurrido en dicha fecha
